<?php require '../php/header.php'?>
    ...
    <main class="main">
        <img src="../image/mecanique.jpeg" alt=" photo de mecanique voiture" class="p-vehicule-occ">
        <h2>Réparation et entretien automobile
            toutes marques</h2>
        <div class="trait"></div>
        <div class="texte">
            <p>Peu importe la marque ou le modèle de votre véhicule, Select auto est en mesure de vous proposer
                d’excellentes
                ...
                Quel que soit votre besoin, un spécialiste est là pour vous conseiller au mieux !</p>
        </div>
        <img src="../image/mecanicien.jpeg" alt="phot de mecanicien" class="photo-mecanique">
        <h2>Diagnostic électronique</h2>
        <div class="trait"></div>
        <div class="texte">
            <p>Aujourd’hui, il est très difficile de déceler tout seul une panne électronique sur son véhicule. À cause
                de l’évolution
                ...
                N’hésitez pas à prendre rendez-vous avec v.parrot pour le diagnostic électronique de votre voiture !</p>
        </div>
        <img src="../image/diag.jpeg" alt="photo diagnostic voiture" class="photo-mecanique">
        <h2>révision</h2>
        <div class="texte">
            <p>La révision de votre véhicule est indispensable !
